                ...
                <form onSubmit={replyStoreHandler}>
                    <div className="flex">
                        ...
                        <div className="w-full">
                            <div className="mb-2">
                                <textarea placeholder="Whrite your comment here..." className="bg-white w-full rounded-lg shadow resize-none border-transparent focus:border-blue-400 focus:ring focus:ring-blue-100 transition duration-200" name="body" value={data.body} onChange={handleChange} />
                            </div>
